...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center" style="color: green;"><span class="glyphicon glyphicon-ok-circle"></span> Added in Cart Successfully Let's Checkout.</h1>
        </div>
    </div>
    <br>

    <h2 class="text-center"> Thank you for visiting Shetkari Seed! We wish you have a safe. </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                <h4> <strong>Seed Name: </strong> <?php echo $car_name; ?></h4>
                <br>
                <h4> <strong>Seed Number:</strong> <?php echo $car_nameplate; ?></h4>
                <br>
                
                <?php     
                if($charge_type == "days"){
                ?>
                     <h4> <strong>Amount:</strong> ₹<?php echo $fare; ?>/kg</h4>
                <?php } else {
                    ?>
                    <h4> <strong>Amount:</strong> ₹<?php echo $fare; ?>/kg</h4>
                ...
                <br>
                <h4> <strong>Delivery Date: </strong> <?php echo $rent_start_date; ?></h4>
                <br>
                <h4> <strong>Expected Delivery Date: </strong> <?php echo $rent_end_date; ?></h4>
                <br>
                <h4> <strong>Agent Name: </strong> <?php echo $driver_name; ?> </h4>
                <br>
                <h4> <strong>Agent Gender: </strong> <?php echo $driver_gender; ?> </h4>
                <br>
                <h4> <strong>Agent ID number: </strong>  <?php echo $dl_number; ?> </h4>
                <br>
                <h4> <strong>Agent Contact:</strong>  <?php echo $driver_phone; ?></h4>
                <br>
