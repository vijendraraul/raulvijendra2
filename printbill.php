    ...
    <div class="container">
        ...
        <div class="box">
            ...
            ?></h4>
                ...
                <br>
                <h4> <strong>Seed Return Date: </strong> <?php echo $car_return_date; ?> </h4>
                <br>
                <?php if($charge_type == "days"){?>
                    <h4> <strong>Number of days for Delivery:</strong> <?php echo $distance_or_days; ?>day(s)</h4>
                <?php } else { ?>
                    <h4> <strong>Quantity:</strong> <?php echo $distance_or_days; ?>kg(s)</h4>
                <?php } ?>
                <br>
                <?php
                    if($extra_days > 0){
